...
const { doSignUp, doLogin, sentVerifyEmail, generateLink, verifyEmail, confirmUserWithNumber, doSignUpWithGoogle, doLoginWithGoogle, generateOtp, verifyOtp, updatePassword, checkEmailValidity, getEmailWithId, getUserWithNumber, getUserDetailsWithId, editUserDetailsHelpers, updateUserPasswordHelper, deleteAUserHelper } = userAuthHelpers;
...
const userLoginWithGoogle = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const accessToken = yield createJwtAccessToken(response._id.toString());
        const refreshToken = yield createJwtRefreshToken(response._id.toString());
        res.cookie("jwtAccessToken", refreshToken, { httpOnly: true });
        res.status(200).json({
            accessToken,
            userId: response._id.toString(),
            name: response.fname,
...
const deleteUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const dbResponse = yield deleteAUserHelper(req.params.id);
