...
const { registerUser, loginUser, loginUserWithNumber, findUserById, findUserByIdForEmailVerification, registerGoogleUser, loginGoogleUser, saveOtpInDb, checkOtp, updatePasswordDb, findUserByEmail, findUserByNumber, getUserDetailsFromDb, editUserDetailsInDb, updateUserPassInDb, deleteAUser } = authRepo;
class authHelpers {
    doSignUp(regDetails) {
    ...
    editUserDetailsHelpers(userDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log('from hel', userDetails);
    ...
    deleteAUserHelper(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield deleteAUser(new mongoose_1.Types.ObjectId(userId));
            }
            catch (error) {
            }
        });
