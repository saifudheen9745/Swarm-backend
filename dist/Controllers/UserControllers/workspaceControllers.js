...
const { createNewWorkspace, deleteAWorkspace, editWokspace, getWokspace, sentMailToAllMembers, insertMembers, updateDb, findOneWorkspace, } = new workspaceHelpers_1.default();
...
const verifyWorkspaceInvitationLink = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log(workspaceId, decryptEmail, choise);
